...
public class SegundoActivity extends AppCompatActivity {
    ...
    TextView txt_id, txt_nombre,n1,n2,n3,n4, label_porcentaje;
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            ...
                            if (progressStatus>100){
                                ...
                                enviar_data_start_test(fecha,hora);
                                //co
                            //enviar_vo2();
                            }
    ...
    void viewData(String data ){
        ...
        n1.setText(lista[1].replace(" ",""));
        n2.setText(lista[0].replace(" ",""));
        n3.setText(lista[3].replace(" ",""));
        n4.setText(lista[2].replace(" ",""));
    ...
    void enviar_data_start_test(String fecha, String hora){
        ...
        try {
            ...
            paramObject.put("c",n3.getText().toString());
    ...
    void enviarlectura( String id, String fecha, String hora)
    {
            ...
            try {
                ...
                paramObject.put("fecha",fecha);
                paramObject.put("hora",hora);
                paramObject.put("t",n2.getText().toString());
                paramObject.put("r",n1.getText().toString());
                paramObject.put("f",n3.getText().toString());
